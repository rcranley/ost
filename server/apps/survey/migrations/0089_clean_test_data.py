...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for name in usernames:
            objs = orm.Respondant.objects.filter(user__username=name)
            print "Deleting %s Respondants for user %s" %(len(objs), name )
            count += len(objs)
            objs.delete()
        
        print "Deleted %s total Respondants" %(count)
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 18, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'0ab8cc04-66c0-4120-a7aa-c7fc1ef0cf9e'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
