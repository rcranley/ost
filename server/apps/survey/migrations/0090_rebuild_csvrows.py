...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        management.call_command('save_respondents', verbosity=0, interactive=False)
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 29, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'766f6115-20d2-432e-9564-7f8e9667bca6'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
